...
describe('Robots', function () {
	...
	it('should not be disallowed when wildard is used in explicit mode', function () {
		var contents = [
			'User-agent: *',
			'Disallow: /',
		].join('\n')
		...
		expect(robots.isDisallowed(url, userAgent)).to.equal(true)
	...
	it('should be disallowed when at least one user agent equal robots rule in explicit mode', function () {
		var contents = [
			'User-agent: SomeBot',
			'Disallow: /',
			'User-agent: *',
